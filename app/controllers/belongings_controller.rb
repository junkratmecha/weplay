class BelongingsController < ApplicationController
  ...
  def create
      ...
      redirect_to clan_url(@belonging.clan), notice:"「#{@belonging.user.name}」が、グループ：#{@belonging.clan.name}へ加入しました。"
  end
  ...
  def destroy
      ...
      redirect_to clan_url(@clan), notice: "グループ「#{@clan.name}」を退会しました。"    
  end
